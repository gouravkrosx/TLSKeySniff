...
type bpfMapSpecs struct {
	...
	MasterSecretBufferHeap *ebpf.MapSpec `ebpf:"master_secret_buffer_heap"`
...
type bpfMaps struct {
	...
	MasterSecretBufferHeap *ebpf.Map `ebpf:"master_secret_buffer_heap"`
